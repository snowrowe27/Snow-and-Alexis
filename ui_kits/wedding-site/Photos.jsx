function Photos(){
 return <Section id="photos" tone="card">
  ...
  <p style={{textAlign:'center',fontFamily:'var(--font-script)',fontSize:'clamp(1.5rem,2.6vw,2rem)',color:'var(--olive)',marginTop:'var(--space-6)'}}>Venice, Tuscany, and a night we don't fully remember.</p>
 </Section>;
}
