...
function Hero({go}){
 return <div id="top" style={{position:'relative',background:'var(--cream-100)',padding:'var(--space-8) var(--gutter-page) var(--space-7)',overflow:'hidden',textAlign:'center'}}>
  ...
  <span aria-hidden="true" className="heroChand ds-chand" style={{position:'absolute',top:-2,left:'5%',width:118,height:143,display:'block',transformOrigin:'top center',animation:'heroChandSway 7s ease-in-out infinite',animationDelay:'-3.5s',background:'var(--villa-green)',WebkitMaskImage:'url('+ILL+'/chandelier.png)',maskImage:'url('+ILL+'/chandelier.png)',WebkitMaskRepeat:'no-repeat',maskRepeat:'no-repeat',WebkitMaskPosition:'top center',maskPosition:'top center',WebkitMaskSize:'contain',maskSize:'contain'}}/>
  <span aria-hidden="true" className="heroChand ds-chand" style={{position:'absolute',top:-2,right:'5%',width:118,height:143,display:'block',transformOrigin:'top center',animation:'heroChandSway 7s ease-in-out infinite',background:'var(--villa-green)',WebkitMaskImage:'url('+ILL+'/chandelier.png)',maskImage:'url('+ILL+'/chandelier.png)',WebkitMaskRepeat:'no-repeat',maskRepeat:'no-repeat',WebkitMaskPosition:'top center',maskPosition:'top center',WebkitMaskSize:'contain',maskSize:'contain'}}/>
