 ...
 return <React.Fragment>
  ...
  <StripeSurfaceDay as="section" tone="sage" style={{padding:'var(--space-9) var(--gutter-page)'}}>
   <div style={{maxWidth:760,margin:'0 auto'}}>
    ...
    <div style={{marginTop:30,background:'var(--cream-50)',border:'1.5px solid var(--miami-orange)',borderRadius:'var(--radius-lg)',padding:'var(--space-5) var(--space-6)'}}><p style={{fontFamily:'var(--font-hand)',fontWeight:600,fontSize:'clamp(1.875rem,3.2vw,2.5rem)',lineHeight:1.25,color:'var(--orange-600)',textAlign:'center',margin:0}}>Villa Woodbine kicks us out at 11.<span style={{position:'relative',display:'inline-block',margin:'0 .18em 0 .3em'}}><span aria-hidden="true" style={{display:'inline-block',fontSize:'1.1em',transform:'translateY(0.05em)'}}>^</span><span style={{position:'absolute',left:'50%',bottom:'0.82em',transform:'translateX(-50%) rotate(-10deg)',fontSize:'0.8em',lineHeight:1,whiteSpace:'nowrap'}}>rude</span></span> If you're still standing and want to keep the party going, stick with us. We know a place. That's all we're saying.</p></div>
   </div>
  </StripeSurfaceDay>
 </React.Fragment>;
}
